...
namespace ReDoMusic.Persistence.Migrations
{
    ...
    [Migration("20231028133435_mig_1_added_category")]
    partial class mig_1_added_category
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReDoMusic.Core.Domain.Entities.Brand", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ReDoMusic.Core.Domain.Entities.Instrument", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ReDoMusic.Core.Domain.Entities.Instrument", b =>
                {
                    b.HasOne("ReDoMusic.Core.Domain.Entities.Brand", "Brand")
                        .WithMany()
